                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" cols="10" rows="10" class="form-control" placeholder="House number and street name">
...
{{--                            </div>--}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="price" value="{{ Session::get('price') }}" class="form-control" placeholder="" readonly disabled>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="user_id" value="{{ \Illuminate\Support\Facades\Auth::user()->id }}" class="form-control" placeholder="" readonly disabled>
                                </div>
                            </div>
